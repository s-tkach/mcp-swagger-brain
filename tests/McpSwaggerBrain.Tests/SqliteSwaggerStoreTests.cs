...
using McpSwaggerBrain.Tests.Fakes;
using McpSwaggerBrain.Tests.Fixtures;
using McpSwaggerBrain.Tests.Support;
...
public sealed class SqliteSwaggerStoreTests
{
    ...
    private static SqliteSwaggerStore CreateStore(IOptions<McpSwaggerBrainOptions> options) =>
        new(
            options,
